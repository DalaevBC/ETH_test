...
#Результат
#### Если я правильно понял, то нам нужно просто брать цены и сравнивать между собой. 
Если брать цену ETHUSDT прямо с апи бинанса, то нам и не помешает BTCUSDT
По сему могу предложить наиболее простой ответ:)))